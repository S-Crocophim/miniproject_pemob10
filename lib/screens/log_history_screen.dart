...
class LogHistoryScreen extends StatelessWidget {
  ...
  String _formatTimestamp(DateTime? dt) {
    if (dt == null) return "No date available";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(roomName != null ? 'Log: $roomName' : 'All Activity Logs'),
            ...
            child: StreamBuilder<List<ActivityLog>>(
              ...
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || snapshot.data!.isEmpty) {
                  return const Center(child: Text('No activity has been recorded for this filter.'));
                }
